...
namespace ZXing.QrCode
{
    ...
    public sealed class QRCodeWriter : Writer
    {
        ...
        /// <param name="current">The current number of concatenated QR code</param> // ’Ç‰Á
        /// <param name="last">The last number of concatenated QR code</param>       // ’Ç‰Á
        /// <param name="parity">The parity value of concatenated QR code</param>    // ’Ç‰Á
        /// <returns>
        /// The generated barcode as a Matrix of unsigned bytes (0 == black, 255 == white)
        /// </returns>
        public BitMatrix encode_sa(byte page, byte totalpage, int parity,
            string contents, BarcodeFormat format,
            int width, int height, IDictionary<EncodeHintType, object> hints)    //Rifat Code Adding New
        {
            ...
            {
                //throw new IllegalArgumentException(&quot; Can only encode QR_CODE, but got & quot; +format);
            ...
            //QRCode code;
            //var tt = code.Version.VersionNumber;
            QRCode code1 = new QRCode();
            var code=Encoder.encode_sa(page, totalpage, parity, contents, errorCorrectionLevel, hints);  // I have to edit from here 
            ...
            // Encoder.encode("shhs", ErrorCorrectionLevel.L);
            //  ErrorCorrectionLevel ss = new ErrorCorrectionLevel("L");
        ...
        /// The generated barcode as a Matrix of unsigned bytes (0 == black, 255 == white)
        /// </returns>
        public BitMatrix encode_sa1(String contents,
                        BarcodeFormat format,
                        int width,
                        int height,
                        IDictionary<EncodeHintType, object> hints,
                        ...
                        byte parity)  // ’Ç‰Á
        {
            ...
            var code = Encoder.encode_sa1(contents, errorCorrectionLevel, hints, current, last, parity);
            return renderResult(code, width, height, quietZone);
        }
