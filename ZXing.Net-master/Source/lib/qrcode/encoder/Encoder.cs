...
namespace ZXing.QrCode.Internal
{
    ...
    public static class Encoder
    {
        ...
        /// <param name="current">The current.</param> // í«â¡
        /// <param name="last">The last.</param>       // í«â¡
        /// <param name="parity">The parity.</param>   // í«â¡
        /// <returns></returns>
        public static QRCode encode_sa1(String content,
        ...
        //Now I will Use This as here Version Got Problem
        public static QRCode encode_sa(byte page, byte totalpage, int parity, String content,
                          ErrorCorrectionLevel ecLevel,
                          IDictionary<EncodeHintType, object> hints
                          ) //throws WriterException
        {
            ...
            // initQRCode(numInputBits, ecLevel, mode, qrCode);  I don`t know how to Inialize it  I tnink I have to fix it from here 
